...
# To generate a valid pass: printf "%q" $(mkpasswd -m sha256crypt admin) - nosexinthechurch for root
...
IMAGE_INSTALL += " weston-xwayland xwayland pi-bluetooth bluez5 iw wpa-supplicant linux-firmware-bcm43455 busybox-udhcpc rsync parted util-linux screen lsof wget net-tools ntp base-files u-boot u-boot-fw-utils"
IMAGE_INSTALL += " tree i2c-tools nano rauc jq v4l-utils" 
...
IMAGE_INSTALL += " lib32-packagegroup-qt5-toolchain-target ldd util-linux lsof lib32-libxml2 file "

PACKAGE_EXCLUDE_COMPLEMENTARY = "lib32-glibc-locale-.*"
PACKAGE_EXCLUDE_COMPLEMENTARY_class-nativesdk = ""
