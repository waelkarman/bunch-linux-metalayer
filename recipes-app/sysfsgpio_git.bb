...
SRC_URI = "git://git@github.com/waelkarman/Raspberry-Pi-Sysfs-GPIO-C-Library.git;user=waelkarman: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;protocol=ssh;branch=master"
