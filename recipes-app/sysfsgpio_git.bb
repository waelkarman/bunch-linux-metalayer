...
SRC_URI = "git://git@github.com/waelkarman/Raspberry-Pi-Sysfs-GPIO-C-Library.git;user=waelkarman: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;protocol=ssh;branch=master"
